  ...
  return (
    <div>
      <PageHeader
        ...
        actions={canWrite ? <Button onClick={() => setShowCreate(true)}>{t('pages.attendance.addButton')}</Button> : undefined}
      />

      {showCreate && (
        <Modal title={t('pages.attendance.createTitle')} onClose={() => setShowCreate(false)}>
